...
g <-ggplot(data=profileResults$lim_or_dtable, mapping=aes(x=x, y=y/profileResults$ncol, fill=intensity, color=intensity, 
		width=1.01*(profileResults$data[2,1]-profileResults$data[1,1]) ) ) + 
	layer(geom="tile", stat = "identity", position = "identity") +
...
g2 <- ggplot(data=profileResults$lim_or_dtable, mapping=aes(x=x, y=y/profileResults$ncol, fill=intensity, color=intensity, 
		width=1.01*(profileResults$data[2,1]-profileResults$data[1,1]) ) ) + 
	layer(geom="tile", stat = "identity", position = "identity") +
	scale_y_continuous(expand=c(0,0), breaks=seq(0,1,0.25), trans="reverse") + 
	scale_x_continuous(expand=c(0,0)) +
	...
	scale_fill_gradientn(colours=rev(brewer.pal(9, "YlGnBu"))) + 
	scale_color_gradientn(colours=rev(brewer.pal(9,"YlGnBu"))) + 
	labs(x="distance from midcell (um)", y="fraction of cell cycle", title="2- position=\"left\"")
...
standard_aes_w	<- function(x1,x2)  1.01*(x1-x2)
...
standard_x		<- scale_x_continuous(expand=c(0,0))
...
standard_layer	<- layer(geom="tile", stat = "identity", position = "identity")
...
pt3<-ggplot(profileResults$lim_or_dtable, aes(x=x, y=y/profileResults$ncol, fill=intensity, color=intensity, width=standard_aes_w(profileResults$data[2,1], profileResults$data[1,1]) ) ) + standard_layer + standard_theme + standard_y + standard_x + standard_fill + standard_color + standard_labs + labs(title="3- contrast=\"native\"\n")
...
pt4<-ggplot(profileResults$lim_or_dtable, aes(x=x, y=y/profileResults$ncol, fill=intensity, color=intensity, width=standard_aes_w(profileResults$data[2,1], profileResults$data[1,1]) ) ) + standard_layer + standard_theme + standard_y + standard_x + standard_fill + standard_color + standard_labs +labs(title="4- contrast=\"max\",\n range=c(0,1)")
...
pt5<-ggplot(profileResults$lim_or_dtable, aes(x=x, y=y/profileResults$ncol, fill=intensity, color=intensity, width=standard_aes_w(profileResults$data[2,1], profileResults$data[1,1]) ) ) + standard_layer + standard_theme + standard_y + standard_x + standard_fill + standard_color + standard_labs + labs(title="5- contrast=\"norm\",\n range=c(0,1)")
...
pt6<-ggplot(profileResults$lim_or_dtable, aes(x=x, y=y/profileResults$ncol, fill=intensity, color=intensity, width=standard_aes_w(profileResults$data[2,1], profileResults$data[1,1]) ) ) + standard_layer + standard_theme + standard_y + standard_x + standard_fill + standard_color + standard_labs + labs(title="6- contrast=\"norm\",\n range=c(0.005,0.995)")
...
pt7<-ggplot(profileResults$lim_or_dtable, aes(x=x, y=y/profileResults$ncol, fill=intensity, color=intensity, width=standard_aes_w(profileResults$data[2,1], profileResults$data[1,1]) ) ) + standard_layer + standard_theme + standard_y + standard_x + standard_fill + standard_color + standard_labs + labs(title="7- contrast=\"norm\",\n range=c(0.02,0.98)")
...
pt8<-ggplot(profileResults$lim_or_dtable, aes(x=x, y=y/profileResults$ncol, fill=intensity, color=intensity, width=standard_aes_w(profileResults$data[2,1], profileResults$data[1,1]) ) ) + standard_layer + standard_theme + standard_y + standard_x + standard_fill + standard_color + standard_labs + labs(title="8- contrast=\"norm\",\n range=c(0.05,0.95)")
...
pt9<-ggplot(profileResults$lim_or_dtable, aes(x=x, y=y/profileResults$ncol, fill=intensity, color=intensity, width=standard_aes_w(profileResults$data[2,1], profileResults$data[1,1]) ) ) + standard_layer + standard_theme + standard_y + standard_x + standard_fill + standard_color + standard_labs + labs(title="9- align=\"native\",\n contrast=\"max\"")
...
pt10<-ggplot(profileResults$lim_or_dtable, aes(x=x, y=y/profileResults$ncol, fill=intensity, color=intensity, width=standard_aes_w(profileResults$data[2,1], profileResults$data[1,1]) ) ) + standard_layer + standard_theme + standard_y + standard_x + standard_fill + standard_color + standard_labs + labs(title="10- align=\"orient\",\n contrast=\"max\"")
...
pt11<-ggplot(profileResults$lim_or_dtable, aes(x=x, y=y/profileResults$ncol, fill=intensity, color=intensity, width=standard_aes_w(profileResults$data[2,1], profileResults$data[1,1]) ) ) + standard_layer + standard_theme + standard_y + standard_x + standard_fill + standard_color + standard_labs +labs(title="11- align=\"random\",\n contrast=\"max\"")
...
pt12<-ggplot(profileResults$lim_or_dtable, aes(x=x, y=y/profileResults$ncol, fill=intensity, color=intensity, width=standard_aes_w(profileResults$data[2,1], profileResults$data[1,1]) ) ) + standard_layer + standard_theme + standard_y + standard_x + standard_fill + standard_color + standard_labs + labs(title="12- align=\"orient\", reverse=TRUE, \ncontrast=\"max\"")
...
pt13<-ggplot(profileResults$lim_or_dtable, aes(x=x, y=y/profileResults$ncol, fill=intensity, color=intensity, width=standard_aes_w(profileResults$data[2,1], profileResults$data[1,1]) ) ) + standard_layer + standard_theme + standard_y + standard_x + standard_fill + standard_color + standard_labs + labs(title="13- align=\"reuse\", reverse=TRUE, \ncontrast=\"max\"")
...
pt14<-ggplot(profileResults$lim_or_dtable, aes(x=x, y=y/profileResults$ncol, fill=intensity, color=intensity, width=standard_aes_w(profileResults$data[2,1], profileResults$data[1,1]) ) ) + standard_layer + standard_theme + standard_y + standard_x + standard_fill + standard_color + standard_labs + labs(title="14- align=\"reuse\", reverse=TRUE, \ncontrast=\"max\"")
...
pt15 <- ggplot(data=profileResults$prop_dtable, mapping=aes(x=x, y=intensity, group=cell ) ) + 
		geom_line(stat="identity", position="identity", alpha=1/sqrt(profileResults$ncol) ) +
		theme_bw(base_size=10) +
		coord_cartesian(xlim=c(0,1)) +
		labs(x="fraction of cell length",y="normalized intensity",title="15- line plots of individual profiles \n")
...
pt16 <- ggplot(data=profileResults$prop_dtable, mapping=aes(x=x, y=intensity, group=cell, color=factor(half)) ) + 
		geom_line(stat="identity", position="identity", alpha=1/sqrt(profileResults$ncol)) + 
		theme_bw(base_size=10) + 
		coord_cartesian(xlim=c(0,1)) + 
		...
		labs(x="fraction of cell length", y="normalized intensity", title="16- line plots split between short & long cells \n")
...
pt17 <- ggplot(data=interp_dtable, mapping=aes(x=x, y=intensity, group=cell, color=factor(half))) + 
		geom_line(stat="identity", position="identity", alpha=3/sqrt(profileResults$ncol)) + 
		stat_summary(mapping=aes(x=x, y=intensity, group=factor(half)), fun.data="mean_cl_boot", geom="smooth", alpha=0.75, fill="black", color=NA) + 
		stat_summary(mapping=aes(x=x, y=intensity, group=half, color=factor(half)), fun.y="mean", geom="line", size=1.25) + 
		coord_cartesian(xlim=c(0,1)) + 
		scale_color_brewer(palette="Set1") + 
		scale_fill_brewer(palette="Set1") + 
		theme_bw(base_size=10) + 
		theme(legend.position="none") + 
		labs(x="fraction of cell length", y="normalized intensity", title="17- line plots split between short\nmedium & long cells (simple mean & confidence)")
...
pt18 <- ggplot(data=lengths, mapping=aes(x=lengths)) + 
		...
		theme_bw(base_size=10) + scale_x_continuous(expand=c(0,0)) + 
...
pt19 <- ggplot(data=profileResults1$lim_or_dtable, mapping=aes(x=x, y=y/profileResults1$ncol, fill=rgb(r,g,0), color=rgb(r,g,0), 
			width=1.01*(profileResults$data[2,1]-profileResults$data[1,1]) ) ) + 
		layer(geom="tile", stat = "identity", position = "identity") +
		scale_y_continuous(expand=c(0,0), breaks=seq(0,1,0.25), trans="reverse") + 
		scale_x_continuous(expand=c(0,0)) +
...
pt20 <- ggplot(data=profileResults1$lim_or_dtable, mapping=aes(x=x, y=y/profileResults1$ncol, fill=rgb(r,(0.5*g+0.5*r),g), color=rgb(r,(0.5*g+0.5*r),g), 
			width=1.01*(profileResults$data[2,1]-profileResults$data[1,1]) ) ) + 
		layer(geom="tile", stat = "identity", position = "identity") +
		scale_y_continuous(expand=c(0,0), breaks=seq(0,1,0.25), trans="reverse") + 
		scale_x_continuous(expand=c(0,0)) +
